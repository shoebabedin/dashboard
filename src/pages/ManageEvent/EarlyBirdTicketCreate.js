import EarlyBirdTicketInfo from 'components/EventsComponents/EarlyBirdTicketInfo';
import { useState } from 'react';
import { Link } from 'react-router-dom';
import EarlyBirdTicketConfig from './EarlyBirdTicketConfig';
import EarlyBirdTicketHolderInfo from './EarlyBirdTicketHolderInfo';

const EarlyBirdTicketCreate = ({ setCreateTicket }) => {
      ...
      <div className="dash_content_main_center">
        <div className="row">
          <div className="col-md-5">
            <div className="form_left_col form_left_col_wthback oflow-hd">
              <div className="backbtnwithtxt oflow-hd">
                <Link to="#" onClick={() => setCreateTicket(false)}>
                ...
                <ul>
                  ...
                  <li className={step === 3 && 'current'}>
                    <Link to="#" onClick={() => setStep(3)}>
                      ...
                      <p>Customer/Ticket Holder’s Information</p>
                    </Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="col-md-7">
            {step === 1 && <EarlyBirdTicketInfo />}
            {step === 2 && <EarlyBirdTicketConfig />}
            {step === 3 && <EarlyBirdTicketHolderInfo />}
          </div>
        </div>
      </div>
...
export default EarlyBirdTicketCreate;
