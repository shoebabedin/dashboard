import TicketConfig from 'components/EventsComponents/TicketConfig';
import TicketHolderInfo from 'components/EventsComponents/TicketHolderInfo';
import TicketInformation from 'components/EventsComponents/TicketInformation';
import { useState } from 'react';
import { Link } from 'react-router-dom';

const SingleEventTicketCreate = () => {
      ...
      <div className="dash_content_main_center">
        <div className="row">
          ...
          <div className="col-md-7">
            {step === 1 && <TicketInformation />}
            {step === 2 && <TicketConfig />}
            {step === 3 && <TicketHolderInfo />}
          </div>
        </div>
      </div>
...
export default SingleEventTicketCreate;
