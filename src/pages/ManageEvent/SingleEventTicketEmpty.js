...
const SingleEventTicketEmpty = ({ setCreateTicket }) => {
  return (
    <>
      <div className="dash_content_main_center">
        <div className="dash_content_main_center_with_padding">
          ...
          <div className="noitememptybox oflow-hd">
            <p>You didn’t add any ticket yet</p>
            <Link to="#" onClick={() => setCreateTicket(true)}>
              Create Ticket
            </Link>
          </div>
        </div>
...
export default SingleEventTicketEmpty;
